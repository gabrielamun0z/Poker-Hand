...
firstRoundBtn.onclick = async () => {
  ...
  discardedCards = data.discardCards || [];

  probability.textContent = "Probabilidad de victoria: " + data.win_prob_pct + "%";
...
verifyBtn.onclick = async () => {
  ...
  // Limpia descartes y probabilidad
...
secondRoundBtn.onclick = async () => {
  ...
  // ❌ No mostramos ya descartes ni probabilidad
  discardedRow.innerHTML = "";
  probability.textContent = "";
